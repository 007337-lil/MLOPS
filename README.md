...
Le dépôt contient l'ensemble des données, scripts python et notebooks créés pour la réalisation de notre projet de MLOps.
...
- @Solsopoivre : Paul Hamann Cossart
